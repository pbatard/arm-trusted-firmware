...
/*
 * Serial ports: PL011 and 'Mini UART'
 */
#define RPI3_IO_PL011_OFFSET		ULL(0x00201000)
#define RPI3_PL011_UART_BASE		(RPI_IO_BASE + RPI3_IO_PL011_OFFSET)
#define RPI3_PL011_UART_CLK_IN_HZ	ULL(48000000)

#define RPI3_IO_MINI_UART_OFFSET	ULL(0x00215040)
#define RPI3_MINI_UART_BASE		(RPI_IO_BASE + RPI3_IO_MINI_UART_OFFSET)
#define PLAT_RPI4_VPU_CLK_RATE		ULL(2000000000)
